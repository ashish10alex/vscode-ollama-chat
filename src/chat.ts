...
<body class="bg-[#1e1e1e] text-[#d4d4d4] font-sans h-screen flex flex-col">
    ...
    <button 
        id="refreshBtn" 
        class="absolute top-4 right-10 flex items-center gap-2 px-3 py-2 bg-[#0066AD] text-white rounded-lg hover:bg-[#0077CC] transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#0066AD]"
        title="New Chat"
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
