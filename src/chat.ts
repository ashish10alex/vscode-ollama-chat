...
<body class="bg-[#1e1e1e] text-[#d4d4d4] font-sans h-screen flex flex-col">
    ...
    <button 
        id="refreshBtn" 
        class="absolute top-4 right-4 p-2 bg-[#0066AD] text-white rounded-full hover:bg-[#0077CC] transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#0066AD]"
    >
